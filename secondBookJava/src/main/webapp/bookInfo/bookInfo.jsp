...
<body>
	  ...
	  <%--    </s:if>  --%>
	        <table>
	            <tr>
	                ...
	                <td class="right_cell">
	                	<s:if test="%{bool==true}">   
	                    	 库存&nbsp;&nbsp;<s:property value="numStock"/>本
                   		</s:if>
                   		<s:else>
	              ...
	              <tr>
	                ...
	                <td class="right_cell" style="color:red">价格&nbsp;&nbsp;<span style="font-size:3vmax;">￥<s:property value="bookPrice"/></span></td>
	            </tr>
	        </table>
	...
	<div class="third">
	   <ul>
	       ...
	       <li><s:property value="publishYear"/>出版</li>
	   </ul>
	</div>
